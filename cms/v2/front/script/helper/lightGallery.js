(function($) {
	$.fn.lightGallery = function(settings) {
		...
		var jQueryCurrentObj = this; // This, in this context, refer to jQuery object
		/**
		...
		function _initialize() {
			_start(this,jQueryCurrentObj); // This, in this context, refer to object (link) which the user have clicked
		 ...
		 * @param object jQueryCurrentObj The jQuery object with all elements matched
		 */
		function _start(objClicked,jQueryCurrentObj) {
			...
			var graphicsData = $(objClicked).attr('data-graphic');
...
var miscUrl = "http://misc.fucms.com/public-misc/5046be746d5461db12000000/";
			if ( graphicsObj.items.length == 1 ) {
				...
				for ( var i = 0; i < graphicsObj.items.length; i++ ) {
					settings.imageArray.push(new Array(miscUrl + graphicsObj.items[i], ""));
				}
			}
			_set_image_to_view();
		}
